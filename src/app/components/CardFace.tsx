...
export function CardFace({
  ...
  type, stickerLabel, userName, userRole, fontStyle, imageData,
}: CardFaceProps) {
    ...
    return (
      <>
        <div style={{
          ...
          fontFamily: fontStyle || undefined,
        }}>
    ...
    <div className="relative w-full h-full" style={{ perspective: "800px" }}>
      ...
      >
        ...
        <div
          ...
          style={{ backfaceVisibility: "hidden", borderRadius: "inherit", overflow: "hidden", ...cardStyle }}
        >
          <div style={{
            fontSize: small ? 13 : 15, fontWeight: 700, color: textColor, lineHeight: 1.3,
            padding: small ? "6px 12px" : "8px 14px",
        ...
        <QrBackCard
          dropId={dropId}
          displayName={displayName || userName || handle}
          handle={handle}
